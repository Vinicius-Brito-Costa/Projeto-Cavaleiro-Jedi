...
export default class Produtos extends React.Component{
    ...
    async componentDidMount(){
        let resposta = await fetch("http://localhost/Projeto%20Cavaleiro%20Jedi/projeto-novo/src/PHP/contentJson.php?table=produtos&query=destaque")
    ...
    render(){
        return(
            <main className="container-fluid mx-0 px-0 conteudo-site">
                ...
                <div className="container-fluid w-100 mx-0">
                ...
                <div className="comentario bg-dark">
                    <div className="texto">
